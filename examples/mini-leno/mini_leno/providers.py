class FakeModelClient:
    ...
    Main Leno uses real provider clients behind the same `complete()` shape.
    mini-leno defaults to this fake client so the control loop is visible
    ...
    def complete(self, prompt, max_new_tokens=512, **_kwargs):
        ...
        if "Tool result:" in prompt:
            return "<final>mini-leno read the workspace through a tool and returned a final answer.</final>"
