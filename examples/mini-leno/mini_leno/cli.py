...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Leno agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-leno starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-leno" / "runs")
    return Leno(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-leno> ").strip()
